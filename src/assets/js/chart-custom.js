...
if (jQuery('#amChartWorldMap').length) {
  am4core.useTheme(am4themes_animated),
    ((chart = am4core.create('amChartWorldMap', am4maps.MapChart)).geodata = am4geodata_worldLow),
      ...
      am4core.ready(function () {
        ...
        (i.tooltipText = '{name}'),
          ...
          o.events.on('hit', function (e) {
            ...
            t &&
              ((e.target.isHover = !1),
              (r.geodataSource.url = 'https://www.amcharts.com/lib/4/geodata/json/' + t + '.json'),
        ...
        d.events.on('hit', function () {
          ...
          d.padding(7, 5, 7, 5),
          (d.width = 30),
          (d.icon.path = 'M16,8 L14,8 L14,16 L10,16 L10,10 L6,10 L6,16 L2,16 L2,8 L0,8 L8,0 L16,8 Z M16,8'),
          (d.marginBottom = 10),
...
if (
  ...
  jQuery('#am-stackedcolumn-chart').length &&
    am4core.ready(function () {
      ...
      (e.colors.list = [am4core.color('#827af3'), am4core.color('#b47af3'), am4core.color('#27b345')]),
        (e.data = [
          {
            year: '2016',
            europe: 2.5,
      ...
      function n(t, a) {
        ...
        (n.name = a),
          ...
          (n.columns.template.tooltipText = '[bold]{name}[/]\n[font-size:14px]{categoryX}: {valueY}');
  ...
  jQuery('#am-barline-chart').length &&
    am4core.ready(function () {
      ...
      (e.colors.list = [am4core.color('#827af3'), am4core.color('#827af3')]),
        (e.data = [
          {
            year: '2005',
            income: 23.5,
  ...
  jQuery('#am-radar-chart').length &&
    am4core.ready(function () {
      ...
      (t.renderer.axisFills.template.fill = e.colors.getIndex(2)), (t.renderer.axisFills.template.fillOpacity = 0.05);
  ...
  jQuery('#am-polar-chart').length &&
    am4core.ready(function () {
      ...
      (a.category = 'NW'),
        (a.endCategory = 'NW'),
        (a.axisFill.fill = am4core.color('#827af3')),
        (a.axisFill.fillOpacity = 0.3);
      var n = t.axisRanges.create();
      (n.category = 'N'),
        (n.endCategory = 'N'),
        (n.axisFill.fill = am4core.color('#b47af3')),
  ...
  jQuery('#am-layeredcolumn-chart').length &&
    am4core.ready(function () {
      ...
      (e.colors.list = [am4core.color('#27b345'), am4core.color('#827af3')]),
...
jQuery('#home-chart-04').length &&
  ...
  jQuery('#home-chart-05').length &&
    am4core.ready(function () {
      ...
      e.colors.list = [am4core.color('#827af3')];
      for (var t = [], a = 120, n = ['ra', 'De', 'Ca', 'Ja', 'Ri', 'An'], o = 0; o < n.length; o++)
    ...
    am4core.ready(function () {
      ...
      for (
        var t = [],
          a = 100,
          n = 120,
          o = ['Rai', 'Dem', 'Caro', 'Jac', 'Rich', 'Ano', 'Amd', 'Idal', 'Joi', 'Mar', 'Cur', 'Shl', 'Meg'],
          r = 0;
        r < o.length;
        r++
      )
        (n =
          (a += Math.round((Math.random() < 0.5 ? 1 : -1) * Math.random() * 5)) + Math.round(10 * Math.random()) + 3),
          t.push({
            category: o[r],
            open: a,
            close: n,
    ...
    t.hide(),
      e.click(function (a) {
        ...
        var n = $($(this).attr('href')),
          o = $(this);
        o.hasClass('disabled') ||
          (e.addClass('active'), o.parent().addClass('active'), t.hide(), n.show(), n.find('input:eq(0)').focus());
      }),
      a.click(function () {
        ...
        for (var r = 0; r < n.length; r++)
          n[r].validity.valid || ((o = !1), $(n[r]).closest('.form-group').addClass('has-error'));
    ...
    $('.progress-round').each(function () {
      ...
      t > 0 &&
        (t <= 50
          ...
          : (n.css('transform', 'rotate(180deg)'), a.css('transform', 'rotate(' + e(t - 50) + 'deg)')));
    });
  });
