    ...
    QJ7E: function (t, e, n) {
        ...
        Lt = {
          ...
          polygonEnd: function () {
            rt.polygonEnd(),
              ...
              (Lt.lineStart = It),
              (Lt.lineEnd = Tt),
              nt < 0 ? ((mt = -(bt = 180)), (yt = -(Pt = 90))) : wt > S ? (Pt = 90) : wt < -S && (yt = -90),
              (Ot[0] = mt),
              (Ot[1] = bt);
          },
          sphere: function () {
          ...
          if (((Pt = bt = -(mt = yt = 1 / 0)), (jt = []), et(t, Lt), (n = jt.length))) {
            for (jt.sort(Ft), e = 1, o = [(i = jt[0])]; e < n; ++e)
              Vt(i, (r = jt[e])[0]) || Vt(i, r[1])
                ? (zt(i[0], r[1]) > zt(i[0], i[1]) && (i[1] = r[1]), zt(r[0], i[1]) > zt(i[0], i[1]) && (i[0] = r[0]))
                : o.push((i = r));
      ...
      var fe = function (t) {
          ...
          var e = Xt,
            ...
            r = e * e + n * n + i * i;
          return r < _ &&
            ((e = Ht), (n = Zt), (i = qt), Rt < S && ((e = kt), (n = Bt), (i = Wt)), (r = e * e + n * n + i * i) < _)
            ? [NaN, NaN]
            : [I(n, e) * w, B(i / A(r)) * w];
        },
        de = function (t) {
      ...
      function _e(t, e, n, i, r, o) {
        if (n) {
          ...
          for (var c, l = r; i > 0 ? l > o : l < o; l -= s) (c = lt([a, -u * T(l), -u * F(l)])), t.point(c[0], c[1]);
        }
      }
      function Me(t, e) {
        ((e = ht(e))[0] -= t), vt(e);
            ...
            if ((h = (l = t[s]).length))
              for (
                ...
                var y = l[m],
                  ...
                  G = E > M,
                  D = g * _;
                if ((Ee.add(I(D * C * F(E), v * w + D * T(E))), (a += G ? L + C * O : L), G ^ (f >= n) ^ (b >= n))) {
                  var N = ft(ht(p), ht(y));
                  vt(N);
                  var z = ft(o, N);
                  vt(z);
            ...
            p = {
              ...
              polygonEnd: function () {
                ...
                a.length
                  ...
                  : t && (h || (r.polygonStart(), (h = !0)), r.lineStart(), n(null, null, 1, r), r.lineEnd()),
                  h && (r.polygonEnd(), (h = !1)),
                  (a = o = null);
              },
              sphere: function () {
        ...
        return function (a) {
          ...
          function M(o, a) {
            ...
            if ((c && l.push([o, a]), m)) (h = o), (p = a), (f = u), (m = !1), u && (b.lineStart(), b.point(o, a));
              ...
              We(s, P, t, e, n, i)
                ? (v || (b.lineStart(), b.point(s[0], s[1])), b.point(P[0], P[1]), u || b.lineEnd(), (y = !1))
      ...
      function yn() {
        ...
        return (
          ...
          (m.precision = function (p) {
            return arguments.length
              ? ((v = +p), (s = vn(o, r, 90)), (c = mn(e, t, v)), (l = vn(u, a, 90)), (h = mn(i, n, v)), m)
              : v;
          }),
          m
            .extentMajor([
      ...
      var Vn,
        ...
        Qn = {
          ...
          result: function () {
            var t = Kn ? [Un / Kn, Jn / Kn] : Yn ? [qn / Yn, Xn / Yn] : Zn ? [Wn / Zn, Hn / Zn] : [NaN, NaN];
      ...
      var _i = function (t, e) {
          var n,
            ...
            r = 4.5;
          function o(t) {
            return t && ('function' == typeof r && i.pointRadius(+r.apply(this, arguments)), et(t, n(i))), i.result();
          }
          return (
            (o.area = function (t) {
            ...
            ? (function (t, e) {
                function n(i, r, o, a, u, s, c, l, h, p, f, d, g, v) {
                  ...
                  if (b > 4 * e && g--) {
                    var P = a + p,
                      ...
                      G = E - r,
                      D = y * T - m * G;
                    ((D * D) / b > e || C((m * T + y * G) / b - 0.5) > 0.3 || a * p + u * f + s * d < Ti) &&
                ...
                return function (e) {
                  ...
                  function y(i, r) {
                    var o = ht([i, r]),
                      a = t(i, r);
                    n(l, h, c, p, f, d, (l = a[0]), (h = a[1]), (c = i), (p = o[0]), (f = o[1]), (d = o[2]), Ii, e),
                      e.point(l, h);
                  }
                  function b() {
                    (g.point = v), e.lineEnd();
      ...
      function Fi(t) {
        ...
        return (
          ...
          (j.center = function (t) {
            return arguments.length ? ((d = (t[0] % 360) * L), (g = (t[1] % 360) * L), C()) : [d * w, g * w];
          }),
          (j.rotate = function (t) {
            return arguments.length
              ? ((v = (t[0] % 360) * L), (m = (t[1] % 360) * L), (y = t.length > 2 ? (t[2] % 360) * L : 0), C())
              : [v * w, m * w, y * w];
          }),
          (j.angle = function (t) {
      ...
      var Ri = function () {
        ...
        ki = function () {
          return Ri().parallels([29.5, 45.5]).scale(1070).translate([480, 250]).rotate([96, 0]).center([-0.6, 38.7]);
        };
      var Bi = function () {
        var t,
          e,
      ...
      function Ki(t) {
        ...
        return (
          ...
          (r.clipExtent = function (t) {
            return arguments.length
              ? (null == t ? (c = e = n = i = null) : ((c = +t[0][0]), (e = +t[0][1]), (n = +t[1][0]), (i = +t[1][1])),
                l())
              : null == c
              ? null
              : [
      ...
      lr.invert = function (t, e) {
        for (
          ...
          ((o =
            (r =
              (i -= n = (i * (or + ar * r + o * (ur + sr * r)) - e) / (or + 3 * ar * r + o * (7 * ur + 9 * sr * r))) *
              i) *
            r *
            r),
          !(C(n) < _));
              ...
              if (t) {
                ...
                if (e) {
                  ...
                  o != this.north && ((this._north = v.round(o, 8)), (u = !0)),
                    ...
                    u && (this.dispatch('geoBoundsChanged'), this.series && this.series.invalidateDataItems());
                }
              }
            }),
            (e.prototype.getFeature = function () {
      ...
      function Br(t, e, n, i) {
        var r = [];
        -180 == i && (i = -179.9999), -90 == n && (n = -89.9999), 90 == t && (t = 89.9999), 180 == e && (e = 179.9999);
        for (
          var o = Math.min(90, (e - i) / Math.ceil((e - i) / 90)), a = (t - n) / Math.ceil((t - n) / 90), u = i;
          u < e;
          u += o
        ) {
          var s = [];
                ...
                if ((this.geodata && (e = this.geodata), e)) {
                  ...
                  if (
                    ('FeatureCollection' == e.type
                      ...
                      ? (n = [e])
                      : -1 !=
                        ['Point', 'LineString', 'Polygon', 'MultiPoint', 'MultiLineString', 'MultiPolygon'].indexOf(
                          e.type
                        )
                      ? (n = [{ geometry: e }])
                          ...
                          if (o) {
                            ...
                            if (
                              ...
                              c
                                ...
                                : ((c = { multiPolygon: s, id: u, madeFromGeoData: !0 }), r.data.push(c)),
              ...
              for (
                ...
                if (c.length > 1) {
                  for (var l = 1; l < c.length; l++)
                    if (
                      ((a = c[l - 1]), (u = c[l]), (r = i / n), (o = (i += this.distance(a, u)) / n), r <= e && o > e)
                    ) {
                      s = t.length;
                      break;
                    }
                        ...
                        if (r) {
                          ...
                          if ('Point' == a || 'MultiPoint' == a) {
                            ...
                            c
                              ...
                              : ((c = { multiPoint: s, id: u, madeFromGeoData: !0 }), o.data.push(c)),
        ...
        po = (function (t) {
          ...
          return (
                ...
                if ((this.setPropertyValue('imagesToConnect', t, !0), this.handleImagesToConnect(), this.series)) {
                  ...
                  n &&
                    n.series.each(function (t) {
                      t instanceof so &&
                        (t.isReady() || e._disposers.push(t.events.on('ready', e.handleImagesToConnect, e, !1)));
                    });
                }
              },
              enumerable: !0,
              ...
              if (this.imagesToConnect) {
                var i = [],
                  ...
                  o = function (t) {
                    ...
                    if (
                      t instanceof Lr &&
                      (i.push({ longitude: t.longitude, latitude: t.latitude }), !a._imageListeners[t.uid])
                    ) {
                      var r = t.events.on(
                        'propertychanged',
                        function (t) {
            ...
            (e.prototype.validate = function () {
              ...
              if (this.multiLine) {
                if (this.shortestDistance)
                  e.projection.d3Projection.precision(0.1), (this.line.path = e.projection.d3Path(this.getFeature()));
                else {
                  for (var n = [], i = 0, r = this.multiLine.length; i < r; i++) {
                    for (var o = this.multiLine[i], a = [], u = 0, s = o.length; u < s; u++) {
                      var c = o[u],
                        l = this.series.chart.projection.convert({ longitude: c[0], latitude: c[1] });
                      a.push(l);
                    }
                    n.push(a);
                  }
            ...
            Object.defineProperty(e.prototype, 'arrow', {
              get: function () {
                if (!this._arrow) {
                  ...
                  (t.shouldClone = !1), (t.width = 8), (t.height = 10), (t.mapLine = this), (t.position = 0.5);
            ...
            (e.prototype.getTooltipX = function () {
              ...
              return (
                t instanceof ho.a || (t = Object(ho.c)(50)), t instanceof ho.a ? this.positionToPoint(t.value).x : 0
              );
            }),
            (e.prototype.getTooltipY = function () {
              var t = this.getPropertyValue('tooltipY');
              return (
                t instanceof ho.a || (t = Object(ho.c)(50)), t instanceof ho.a ? this.positionToPoint(t.value).y : 0
              );
            }),
            e
          );
                            ...
                            if ('LineString' == a || 'MultiLineString' == a) {
                              ...
                              'LineString' == a && (s = [s]),
                                c
                                  ...
                                  : ((c = { multiLine: s, id: u, madeFromGeoData: !0 }), r.data.push(c)),
                                Zr.softCopyProperties(i.properties, c);
                            }
                          }
                        },
          ...
          return (
            ...
            (e.prototype.handlePanDown = function (t) {
              ...
              e.x > 0 &&
                ...
                ((this._downPointOrig = Zr.documentPointToSprite(t.pointer.point, this.seriesContainer)),
                  ...
                  u && (s = this.projection.invert(u)),
                    ...
                    s &&
                      (('rotateLat' != e && 'rotateLongLat' != e) ||
                        (this.deltaLatitude = this._downDeltaLatitude + s.latitude - a.latitude),
                      ('rotateLong' != e && 'rotateLongLat' != e) ||
                        (this.deltaLongitude = this._downDeltaLongitude + s.longitude - a.longitude));
                }
              }
            }),
            ...
            (e.prototype.updateZoomGeoPoint = function () {
              var t = Zr.svgPointToSprite(
                  { x: this.innerWidth / 2 + this.pixelPaddingLeft, y: this.innerHeight / 2 + this.pixelPaddingTop },
              ...
              (this.seriesMaxLeft = t),
                ...
                this.seriesWidth > 0 && this.seriesHeight > 0
                  ? ((this.chartContainer.visible = !0),
                    (this._centerGeoPoint = this.projection.invert({ x: t + (e - t) / 2, y: n + (i - n) / 2 })),
            ...
            Object.defineProperty(e.prototype, 'mouseWheelBehavior', {
              ...
              set: function (t) {
                this.setPropertyValue('mouseWheelBehavior', t) &&
                  ('none' != t
                    ? ((this._mouseWheelDisposer = this.chartContainer.events.on('wheel', this.handleWheel, this, !1)),
            ...
            (e.prototype.updateExtremes = function () {
              ...
              this.series.each(function (t) {
                ...
                o ||
                  this.series.each(function (t) {
                    t.ignoreBounds || (t instanceof yo && t.fitExtent) || (r = r.concat(t.getFeatures()));
                  });
                ...
                if (a) {
                  ...
                  return (
                    !r &&
                      ...
                      ((c =
                        this.innerWidth / 2 -
                        (this.seriesMaxLeft + (this.seriesMaxRight - this.seriesMaxLeft) / 2) * e * this.scaleRatio),
                      (l =
                        this.innerHeight / 2 -
                        (this.seriesMaxTop + (this.seriesMaxBottom - this.seriesMaxTop) / 2) * e * this.scaleRatio)),
            ...
            (e.prototype.zoomToRectangle = function (t, e, n, i, r, o, a) {
              ...
              return this.zoomToGeoPoint({ latitude: t + (n - t) / 2, longitude: i + (e - i) / 2 }, u, o, a, !0);
            }),
            ...
            Object.defineProperty(e.prototype, 'deltaLongitude', {
              ...
              set: function (t) {
                this.setPropertyValue('deltaLongitude', ro(t)) && (this.rotateMap(), this.updateZoomGeoPoint());
              },
              enumerable: !0,
              configurable: !0,
            }),
          ...
          return (
            ...
            (e.prototype.updateThumb = function () {
              ...
              if (!n.isDown) {
                ...
                'vertical' == this.layout
                  ? (n.y = t.pixelHeight - ((t.pixelHeight - n.pixelHeight) * i) / this.stepCount - n.pixelHeight)
            ...
            (e.prototype.handleThumbDrag = function () {
              ...
              t =
                ...
                (t =
                  'vertical' == this.layout
                    ? (this.stepCount * (e.pixelHeight - i.pixelY - i.pixelHeight)) / (e.pixelHeight - i.pixelHeight)
      ...
      function Ba(t, e) {
        var n, i, r, o, a;
        if (e < Xo)
          return [(o = Zo(t)) - (n = (e * (t - o * (i = Fo(t)))) / 4) * i, i + n * o, 1 - (e * o * o) / 2, t - n];
        if (e >= 1 - Xo)
          return (
            (n = (1 - e) / 4),
            (r = 1 / (i = sa(t))),
        ...
        var n = ($o - 1) / ($o + 1),
          ...
          u = (function (t, e) {
            var n = t * t,
              i = e + 1,
              r = 1 - n - e * e;
            return [0.5 * ((t >= 0 ? Jo : -Jo) - zo(r, 2 * t)), -0.25 * Ro(r * r + 4 * n) + 0.5 * Ro(i * i + n)];
          })(a * Fo(-1 * t), a * Zo(-1 * t)),
          s = (function (t, e, n) {
            var i = Do(t),
              r = ua(Do(e));
      ...
      Qa.invert = function (t, e) {
        ...
        do {
          var o = n * n,
            ...
            c = i * (1.00384 + o * (0.0802894 + -0.02855 * a + 199025e-9 * o) + a * (0.0998909 + -0.0491032 * a)) - e,
            l = 0.975534 - a * (0.119161 + 3 * o * 0.0143059 + 0.0547009 * a),
            h = -u * (0.238322 + 0.2188036 * a + 0.0286118 * o),
            p = u * (0.1605788 + 7961e-7 * o + -0.0571 * a),
            f = 1.00384 + o * (0.0802894 + 199025e-9 * o) + a * (3 * (0.0998909 - 0.02855 * o) - 0.245516 * a),
            d = h * p - f * l,
            g = (c * h - s * f) / d,
            v = (s * p - c * l) / d;
          (n -= g), (i -= v);
      ...
      yu.invert = function (t, e) {
        ...
        do {
          var r = i * i;
          i -= n = (i * (lu + r * r * (hu + r * (pu + fu * r))) - e) / (du + r * r * (gu + r * (vu + mu * r)));
        } while (Do(n) > Xo);
        return [t, i];
      };
      function bu(t, e) {
            ...
            if (f >= 0 || 1 === o) {
              ...
              do {
                (f = (r = Bo(18, Do(i) / 5)) - (o = Ao(r))),
                  ...
                  (u = Mu[o + 1][1]),
                  (s = Mu[Bo(19, o + 2)][1]),
                  (i -= (d = (e >= 0 ? Jo : -Jo) * (u + (f * (s - a)) / 2 + (f * f * (s - 2 * u + a)) / 2) - e) * na);
              } while (Do(d) > Yo && --g > 0);
              break;
            }
          } while (--o >= 0);
      ...
      Ou.invert = function (t, e) {
        ...
        var n = (t /= Uo) * t,
          ...
          h = 2 * aa(-l / 3),
          p = oa((3 * c) / (l * h)) / 3;
        return [(Uo * (r - 1 + aa(1 + 2 * (n - i) + o))) / (2 * t), Ho(e) * Uo * (-h * Fo(p + Uo / 3) - u / (3 * s))];
      };
      function wu(t, e) {
        if (Do(e) < Xo) return [t, 0];
        var n = Do(e / Jo),
      ...
      wu.invert = function (t, e) {
        ...
        var n = Do(t / Uo),
          i = (1 - n * n - (e /= Uo) * e) / (2 * n),
          r = aa(i * i + 1);
        return [Ho(t) * Uo * (r - i), Ho(e) * Jo * Zo(2 * zo(aa((1 - 2 * i * n) * (i + r) - n), aa(r + i + n)))];
      };
      function Lu(t, e) {
        if (Do(e) < Xo) return [t, 0];
        var n = e / Jo,
      ...
      function Cu(t, e) {
        ...
        var i = n / Jo,
          ...
          f = p * p,
          d =
            (p * (s + a - 1) + 2 * aa(s * (r + a * f - 1) + (1 - r) * (r * (c * c + 4 * a) + 12 * u * a + 4 * a * a))) /
            (4 * s + f);
      ...
      Cu.invert = function (t, e) {
        ...
        do {
          ...
          a -= n =
            (r * (d + h - 1) + 2 * m - i * (4 * d + o)) /
            (r * (2 * c * l + 2 * f * (1 + l)) + v / m - (8 * f * (r * (-1 + h + d) + 2 * m) * (1 + l)) / (o + 4 * d));
        } while (n > Xo && --u > 0);
    ...
    U8r1: function (t, e, n) {
      ...
      function r(t, e, n) {
        ...
        for (var S = v.length; v.length; ) {
          var _ = v.pop();
          _.d > b.d && ((b = _), n && console.log('found best %d after %d probes', Math.round(1e4 * _.d) / 1e4, S)),
            _.max - b.d <= e ||
              ((g = _.h / 2),
