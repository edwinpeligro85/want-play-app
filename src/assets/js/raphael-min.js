...
!(function (a) {
  ...
  (function (a, b) {
    ...
    var u,
      ...
      I = String,
      J = 'split',
      K = 'click dblclick mousedown mousemove mouseout mouseover mouseup touchstart touchmove touchend touchcancel'[J](
        H
      ),
    ...
    var ub = function (a) {
      ...
      yb = function (a, b, d) {
        if (
          (null == b && c.is(a, 'object') && 'r' in a && 'g' in a && 'b' in a && ((d = a.b), (b = a.g), (a = a.r)),
          null == b && c.is(a, U))
        ) {
          var e = c.getRGB(a);
          (a = e.r), (b = e.g), (d = e.b);
    ...
    (c.color = function (a) {
      ...
      (c.getRGB = f(function (a) {
        ...
        return j
          ? (j[2] &&
              ((e = ab(j[2].substring(5), 16)), (d = ab(j[2].substring(3, 5), 16)), (b = ab(j[2].substring(1, 3), 16))),
            j[3] &&
          ...
          function (b, d) {
            return (
              c.is(b, 'function') &&
                ...
                this.events.push({ name: a, f: b, unbind: Wb(this.shape || this.node || A.doc, a, b, d || this) })),
              this
            );
          }),
          (c['un' + a] = $b['un' + a] =
    ...
    (v.getElementByPoint = function (a, b) {
      ...
      ($b.isPointInside = function (a, b) {
        ...
        return (
          this.attr('transform') && this.attr('transform').length && (d = c.transformPath(d, this.attr('transform'))),
            ...
            r = function (a, e) {
              ...
              if (!s) {
                ...
                if (
                  ...
                  a.gradient && k != a.gradient.id && (p.defs.removeChild(a.gradient), delete a.gradient),
                  !a.gradient)
                ) {
                  (s = q(j + 'Gradient', { id: k })),
                    (a.gradient = s),
                    q(
                      ...
                      'radial' == j
                        ? { fx: m, fy: n }
                        : { x1: u[0], y1: u[1], x2: u[2], y2: u[3], gradientTransform: a.matrix.invert() }
                    ),
              ...
              if ('path' == d.type) {
                ...
                if (
                  ...
                  c._g.doc.getElementById(A)
                    ? p[A]++
                    : (n.defs.appendChild(q(q('path'), { 'stroke-linecap': 'round', d: o[w], id: A })), (p[A] = 1));
                  var C,
            ...
            y = function (d, f) {
              if ('text' == d.type && (f[a]('text') || f[a]('font') || f[a]('font-size') || f[a]('x') || f[a]('y'))) {
                var g = d.attrs,
                  h = d.node,
                  i = h.firstChild
                    ? e(c._g.doc.defaultView.getComputedStyle(h.firstChild, l).getPropertyValue('font-size'), 10)
                    : 10;
                if (f[a]('text')) {
          ...
          (z.prototype = A),
            ...
            (A.blur = function (a) {
              ...
              if (0 !== +a) {
                ...
                b._blur && (b._blur.parentNode.removeChild(b._blur), delete b._blur, delete b.attrs.blur),
            ...
            (c._engine.circle = function (a, b, c, d) {
              ...
              var f = new z(e, a);
              return (
                (f.attrs = { cx: b, cy: c, r: d, fill: 'none', stroke: '#000' }), (f.type = 'circle'), q(e, f.attrs), f
              );
            }),
            ...
            B = function (e, i) {
              ...
              if (
                ...
                ((i.path && 'path' == e.type) || q) &&
                  ((l.path = x(~b(m.path).toLowerCase().indexOf('r') ? c._pathToAbsolute(m.path) : m.path)),
                  'image' == e.type &&
              ...
              if (e.textpath) {
                ...
                i.font && (J.font = i.font),
                  i['font-family'] &&
                    (J.fontFamily = '"' + i['font-family'].split(',')[0].replace(/^['"]+|['"]+$/g, o) + '"'),
              ...
              if (
                ...
                if (
                  ...
                  i['stroke-linecap'] &&
                    (P.endcap =
                      'butt' == i['stroke-linecap'] ? 'flat' : 'square' == i['stroke-linecap'] ? 'square' : 'round'),
                  i['stroke-dasharray'])
                ) {
                  var T = {
                    '-': 'shortdash',
          ...
          (D.prototype = E),
            ...
            (E.scale = function (a, c, e, f) {
              ...
              if (
                ((a = b(a).split(k)),
                a.length - 1 &&
                  ((c = d(a[1])), (e = d(a[2])), (f = d(a[3])), isNaN(e) && (e = null), isNaN(f) && (f = null)),
                (a = d(a[0])),
                null == c && (c = a),
                null == f && (e = f),
                null == e || null == f)
