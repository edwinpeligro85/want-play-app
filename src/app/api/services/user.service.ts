...
export class UserService extends BaseService {
  ...
  usersControllerFindAll$Response(params?: {}): Observable<StrictHttpResponse<Array<User>>> {
    const rb = new RequestBuilder(this.rootUrl, UserService.UsersControllerFindAllPath, 'get');
    if (params) {
    }
  ...
  usersControllerFindOne$Response(params: { id: string }): Observable<StrictHttpResponse<{}>> {
    const rb = new RequestBuilder(this.rootUrl, UserService.UsersControllerFindOnePath, 'get');
    if (params) {
  ...
  usersControllerRemove$Response(params: { id: string }): Observable<StrictHttpResponse<string>> {
    const rb = new RequestBuilder(this.rootUrl, UserService.UsersControllerRemovePath, 'delete');
    if (params) {
      rb.path('id', params.id, {});
    }
  ...
  usersControllerUpdate$Response(params: { id: string; body: UpdateUserDto }): Observable<StrictHttpResponse<User>> {
    const rb = new RequestBuilder(this.rootUrl, UserService.UsersControllerUpdatePath, 'patch');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
